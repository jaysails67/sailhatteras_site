...
const ADVISORY_CANDIDATES = [
  ...
  { name: "Brian Palmer",          area: "Battery & Powerplant Technology",  role: "Battery/Powerplant Technology Lead", description: "Brings expertise in energy storage, powertrain architecture, and marine charging systems." },
