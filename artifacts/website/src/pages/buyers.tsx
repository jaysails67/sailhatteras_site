          ...
          <div className="container px-4 md:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <h2 className="text-4xl font-display font-bold mb-6">Pamli T-Series</h2>
                <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                  Urban waterway transit, reimagined. The T-Series is a compact, high-efficiency electric foiling water taxi purpose-built for last-mile connectivity across harbors, rivers, and coastal routes. Quiet, fast, and zero-emission — the perfect fit for busy waterfront cities.
                </p>
                <div className="grid grid-cols-2 gap-6 mb-8">
                  <div>
